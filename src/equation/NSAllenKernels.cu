...
__global__ void KernelInitializeDistributions(const Solver::WMRTvelSet velSet, const InputData::SimParams params, const Domain::DomainInfo domain, CLIP_REAL *dev_f, CLIP_REAL *dev_g, CLIP_REAL *dev_f_post, CLIP_REAL *dev_g_post,
...
#pragma unroll
for (CLIP_UINT q = 0; q < Solver::WMRTvelSet::Q; q++)
{
...
__global__ void kernelStreaming(const Solver::WMRTvelSet velSet, const Domain::DomainInfo domain, double *f, double *f_post)
{
...
__global__ void kernelMacroscopicf(const Solver::WMRTvelSet velSet, const InputData::SimParams params, const Domain::DomainInfo domain,
...
Solver::convertD2Q9Weighted(gneq, tmp);
...
Solver::reconvertD3Q19Weighted(tmp, gneq);
...
__global__ void kernelMacroscopicg(const Solver::WMRTvelSet velSet, const InputData::SimParams params, const Domain::DomainInfo domain,
...
__global__ void kernelCollisionMRTh(const Solver::WMRTvelSet velSet, const InputData::SimParams params, const Domain::DomainInfo domain,
...
__global__ void kernelCollisionMRTg(const Solver::WMRTvelSet velSet, const InputData::SimParams params, const Domain::DomainInfo domain,
